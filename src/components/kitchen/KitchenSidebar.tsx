...
const menuItems = [
  { id: "pesanan", label: "Pesanan", icon: ClipboardList, path: "/kitchen/pesanan" },
  { id: "stok", label: "Stok", icon: Package, path: "/kitchen/stok" },
];
          ...
          <DropdownMenuTrigger asChild>
            <button className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-secondary/50 transition-colors">
              ...
              <div className="flex-1 text-left">
                <p className="text-sm font-medium text-foreground">{user?.name || "Dapur"}</p>
              </div>
              <ChevronDown className="w-4 h-4 text-muted-foreground" />
            </button>
          </DropdownMenuTrigger>
